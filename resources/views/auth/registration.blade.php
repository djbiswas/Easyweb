    ...
    <div class="container">
        <div class="d-flex flex-column align-items-center justify-content-center w-100 vh-100">
            ...
            <div class="account-box px-3 py-5 px-md-4 rounded-lg shadow d-flex flex-column">
                ...
                <small style="font-size: 20px;" class="text-light text-center mb-3">{{ __('User') }} Registration</small>
                ...
                <form method="POST" action="{{ route('registration.store') }}">
                    ...
                    <div class="form-group">
                        <div class="input-group flex-nowrap">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-white" id="signinName"><i class="material-icons-outlined">person</i></span>
                            </div>
                            <input id="name"  class="form-control" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Enter Your Name"  autofocus>
                    ...
                    <div class="form-group">
                        <div class="input-group flex-nowrap">
                            ...
                            <input id="email"  class="form-control" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Enter Your Email"  autofocus>
                    ...
                    <div class="form-group">
                        <div class="input-group flex-nowrap">
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-white" id="signinEmail"><i class="material-icons-outlined">phone</i></span>
                            </div>
                            <input id="phone"  class="form-control" name="phone" value="{{ old('phone') }}" required autocomplete="phone" placeholder="Enter Your Phone Number"  autofocus>
...
{{--                        @endif--}}
                    ...
                    <a href="{{ route('login') }}" class="btn btn-primary px-4 mt-3 w-100 sign-up-btn">Sign in</a>
