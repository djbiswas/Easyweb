                ...
                <div class="card-body card-block">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-4 ">
                            ...
                            {!! Form::select('referrar', $user_list, '1', ['class' => 'form-control','placeholder' => 'Referred By']) !!}
                            @error('referrar')
                            <span>{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        {{-- <div class="form-group col-3 ">
                            ...
                            {{Form::number('member_share', 1, array('class' => 'form-control','placeholder' => 'Member Shares'))}}
                            @error('member_share')
                            <span>{{ $message }}</span>
                            @enderror
                        </div> --}}
                        ...
                        <div class="form-group col-4 ">
                            ...
                            {!! Form::select('user_type_id', $user_types, '1', ['class' => 'form-control','placeholder' => 'Member Type']) !!}
                            @error('user_type_id')
                            <span>{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-4 ">
                            ...
                            {!! Form::select('roles', $roles, '1', ['class' => 'form-control','placeholder' => 'Select Role']) !!}
                            @error('roles')
                            <span>{{ $message }}</span>
                            @enderror
                        </div>
